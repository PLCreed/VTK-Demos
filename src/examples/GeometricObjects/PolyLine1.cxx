...
int main(int, char *[])
{
    ...
    polygon->SetPoints(points.Get());
    polygon->SetLines(lines.Get());
    ...
    polygonMapper->SetInputData(polygon.Get());
    ...
    polygonActor->SetMapper(polygonMapper.Get());
    polygonActor->GetProperty()->SetColor(colors->GetColor3d("AliceBlue").GetData());
