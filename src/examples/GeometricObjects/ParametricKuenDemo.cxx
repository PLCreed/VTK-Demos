...
{
public:
    static SliderCallbackMinimumU *New() { return new SliderCallbackMinimumU; }
...
{
public:
    static SliderCallbackMaximumU *New() { return new SliderCallbackMaximumU; }
    ...
    virtual void Execute(vtkObject *caller, unsigned long, void *)
    {
        ...
        this->Kuen->SetMaximumU(
            static_cast<vtkSliderRepresentation2D *>(sliderWidget->GetRepresentation())->GetValue());
    }
...
{
public:
    static SliderCallbackMinimumV *New() { return new SliderCallbackMinimumV; }
...
{
public:
    static SliderCallbackMaximumV *New() { return new SliderCallbackMaximumV; }
...
int main(int, char *[])
{
    ...
    source->SetParametricFunction(surface.Get());
    ...
    sliderWidgetMinimumU->SetInteractor(interactor.Get());
    sliderWidgetMinimumU->SetRepresentation(sliderRepMinimumU.Get());
    ...
    callbackMinimumU->Kuen = surface.Get();
    ;

    sliderWidgetMinimumU->AddObserver(vtkCommand::InteractionEvent, callbackMinimumU.Get());
    ...
    sliderWidgetMaximumU->SetInteractor(interactor.Get());
    sliderWidgetMaximumU->SetRepresentation(sliderRepMaximumU.Get());
    ...
    callbackMaximumU->Kuen = surface.Get();
    ;

    sliderWidgetMaximumU->AddObserver(vtkCommand::InteractionEvent, callbackMaximumU.Get());
    ...
    sliderWidgetMinimumV->SetInteractor(interactor.Get());
    sliderWidgetMinimumV->SetRepresentation(sliderRepMinimumV.Get());
    ...
    callbackMinimumV->Kuen = surface.Get();
    ;

    sliderWidgetMinimumV->AddObserver(vtkCommand::InteractionEvent, callbackMinimumV.Get());
    ...
    sliderWidgetMaximumV->SetInteractor(interactor.Get());
    sliderWidgetMaximumV->SetRepresentation(sliderRepMaximumV.Get());
    ...
    callbackMaximumV->Kuen = surface.Get();
    ;

    sliderWidgetMaximumV->AddObserver(vtkCommand::InteractionEvent, callbackMaximumV.Get());
