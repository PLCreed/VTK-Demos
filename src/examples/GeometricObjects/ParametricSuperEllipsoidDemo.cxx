...
{
public:
    static SliderCallbackN2 *New() { return new SliderCallbackN2; }
...
int main(int, char *[])
{
    ...
    sliderWidgetN1->SetInteractor(interactor.Get());
    sliderWidgetN1->SetRepresentation(sliderRepN1.Get());
    sliderWidgetN1->SetAnimationModeToAnimate();
    sliderWidgetN1->EnabledOn();

    vtkNew<SliderCallbackN1> callbackN1;
    callbackN1->SuperEllipsoid = surface.Get();
    ;

    sliderWidgetN1->AddObserver(vtkCommand::InteractionEvent, callbackN1.Get());
    ...
    sliderWidgetN2->SetInteractor(interactor.Get());
    sliderWidgetN2->SetRepresentation(sliderRepN2.Get());
    sliderWidgetN2->SetAnimationModeToAnimate();
    sliderWidgetN2->EnabledOn();

    vtkNew<SliderCallbackN2> callbackN2;
    callbackN2->SuperEllipsoid = surface.Get();

    sliderWidgetN2->AddObserver(vtkCommand::InteractionEvent, callbackN2.Get());
