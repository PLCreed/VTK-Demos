...
int main(int, char *[])
{
    ...
    transform->Concatenate(matrix.Get()); // apply direction cosines
    ...
    sphereStart->SetMapper(sphereStartMapper.Get());
    ...
    sphereEnd->SetMapper(sphereEndMapper.Get());
    ...
    renderer->AddActor(sphereStart.Get());
    renderer->AddActor(sphereEnd.Get());
