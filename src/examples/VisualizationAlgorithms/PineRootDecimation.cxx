...
int main(int argc, char *argv[])
{
    ...
    std::cout << "There are: " << NumberofTriangles(reader->GetOutput()) << " triangles." << std::endl;
    ...
    std::cout << "There are: " << NumberofTriangles(deci->GetOutput()) << " triangles." << std::endl;
    ...
    // std::cout << "There are: " << NumberofTriangles(dynamic_cast<vtkPolyData *>(connect->GetOutput())) << "
    // triangles." << std::endl;
