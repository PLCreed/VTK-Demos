...
int main(int, char *[])
{
    ...
    sphere2->SetTransform(trans2.Get());

    vtkNew<vtkImplicitBoolean> booleanUnion;
    booleanUnion->AddFunction(sphere.Get());
    booleanUnion->AddFunction(sphere2.Get());
    booleanUnion->SetOperationType(0); // boolean Union

    vtkNew<vtkExtractGeometry> extract;
    extract->SetInputConnection(sample->GetOutputPort());
    extract->SetImplicitFunction(booleanUnion.Get());
    ...
    dataActor->SetMapper(dataMapper.Get());
