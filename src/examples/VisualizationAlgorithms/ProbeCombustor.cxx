...
int main(int argc, char *argv[])
{
    ...
    tpd1Actor->SetMapper(mapTpd1.Get());
    ...
    tpd2Actor->SetMapper(mapTpd2.Get());
    ...
    tpd3Actor->SetMapper(mapTpd3.Get());
    ...
    planeActor->SetMapper(contourMapper.Get());
    ...
    ren1->AddActor(planeActor.Get());
    ren1->AddActor(tpd1Actor.Get());
    ren1->AddActor(tpd2Actor.Get());
    ren1->AddActor(tpd3Actor.Get());
