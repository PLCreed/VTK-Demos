...
int main(int argc, char *argv[])
{
    if (argc < 2) {
        ...
        std::cout << "Demonstrate the use of vtkPointSource to generate streamlines." << std::endl;
        std::cout << "Where: " << std::endl;
        std::cout << "       filename: office.binary.vtk" << std::endl;
        std::cout << "       center: An optional parameter choosing the center for "
                     "the seeds."
                  << std::endl;
        std::cout << "               0 - Corresponds to Fig 9-47(a) in the VTK textbook." << std::endl;
        std::cout << "               1 - A slight shift to the left." << std::endl;
        std::cout << "               2 - A slight shift to the upper left. (from "
                     "the Original code)."
                  << std::endl;
        std::cout << "               3 - The default, a slight shift to the upper left." << std::endl;
    ...
    center = (center < static_cast<int>(seedCenters.size())) ? center : static_cast<int>(seedCenters.size()) - 1;
    ...
    table1Actor->SetMapper(mapTable1.Get());
    table1Actor->GetProperty()->SetColor(colors->GetColor3d("TableTop").GetData());
    ...
    table2Actor->SetMapper(mapTable2.Get());
    table2Actor->GetProperty()->SetColor(colors->GetColor3d("TableTop").GetData());
    ...
    FilingCabinet1Actor->SetMapper(mapFilingCabinet1.Get());
    FilingCabinet1Actor->GetProperty()->SetColor(colors->GetColor3d("FilingCabinet").GetData());
    ...
    FilingCabinet2Actor->SetMapper(mapFilingCabinet2.Get());
    FilingCabinet2Actor->GetProperty()->SetColor(colors->GetColor3d("FilingCabinet").GetData());
    ...
    bookshelf1TopActor->SetMapper(mapBookshelf1Top.Get());
    bookshelf1TopActor->GetProperty()->SetColor(colors->GetColor3d("BookShelf").GetData());
    ...
    bookshelf1BottomActor->SetMapper(mapBookshelf1Bottom.Get());
    bookshelf1BottomActor->GetProperty()->SetColor(colors->GetColor3d("BookShelf").GetData());
    ...
    bookshelf1FrontActor->SetMapper(mapBookshelf1Front.Get());
    bookshelf1FrontActor->GetProperty()->SetColor(colors->GetColor3d("BookShelf").GetData());
    ...
    bookshelf1BackActor->SetMapper(mapBookshelf1Back.Get());
    bookshelf1BackActor->GetProperty()->SetColor(colors->GetColor3d("BookShelf").GetData());
    ...
    bookshelf1LHSActor->SetMapper(mapBookshelf1LHS.Get());
    bookshelf1LHSActor->GetProperty()->SetColor(colors->GetColor3d("BookShelf").GetData());
    ...
    bookshelf1RHSActor->SetMapper(mapBookshelf1RHS.Get());
    bookshelf1RHSActor->GetProperty()->SetColor(colors->GetColor3d("BookShelf").GetData());
    ...
    bookshelf2TopActor->SetMapper(mapBookshelf2Top.Get());
    bookshelf2TopActor->GetProperty()->SetColor(colors->GetColor3d("BookShelf").GetData());
    ...
    bookshelf2BottomActor->SetMapper(mapBookshelf2Bottom.Get());
    bookshelf2BottomActor->GetProperty()->SetColor(colors->GetColor3d("BookShelf").GetData());
    ...
    bookshelf2FrontActor->SetMapper(mapBookshelf2Front.Get());
    bookshelf2FrontActor->GetProperty()->SetColor(colors->GetColor3d("BookShelf").GetData());
    ...
    bookshelf2BackActor->SetMapper(mapBookshelf2Back.Get());
    bookshelf2BackActor->GetProperty()->SetColor(colors->GetColor3d("BookShelf").GetData());
    ...
    bookshelf2LHSActor->SetMapper(mapBookshelf2LHS.Get());
    bookshelf2LHSActor->GetProperty()->SetColor(colors->GetColor3d("BookShelf").GetData());
    ...
    bookshelf2RHSActor->SetMapper(mapBookshelf2RHS.Get());
    bookshelf2RHSActor->GetProperty()->SetColor(colors->GetColor3d("BookShelf").GetData());
    ...
    windowActor->SetMapper(mapWindow.Get());
    ...
    outletActor->SetMapper(mapOutlet.Get());
    outletActor->GetProperty()->SetColor(colors->GetColor3d("lamp_black").GetData());
    ...
    inletActor->SetMapper(mapInlet.Get());
    inletActor->GetProperty()->SetColor(colors->GetColor3d("lamp_black").GetData());
    ...
    outlineActor->SetMapper(mapOutline.Get());
    ...
    streamersActor->SetMapper(mapStreamers.Get());
    ...
    renderer->AddActor(table1Actor.Get());
    renderer->AddActor(table2Actor.Get());
    renderer->AddActor(FilingCabinet1Actor.Get());
    renderer->AddActor(FilingCabinet2Actor.Get());
    renderer->AddActor(bookshelf1TopActor.Get());
    renderer->AddActor(bookshelf1BottomActor.Get());
    renderer->AddActor(bookshelf1FrontActor.Get());
    renderer->AddActor(bookshelf1BackActor.Get());
    renderer->AddActor(bookshelf1LHSActor.Get());
    renderer->AddActor(bookshelf1RHSActor.Get());
    renderer->AddActor(bookshelf2TopActor.Get());
    renderer->AddActor(bookshelf2BottomActor.Get());
    renderer->AddActor(bookshelf2FrontActor.Get());
    renderer->AddActor(bookshelf2BackActor.Get());
    renderer->AddActor(bookshelf2LHSActor.Get());
    renderer->AddActor(bookshelf2RHSActor.Get());
    renderer->AddActor(windowActor.Get());
    renderer->AddActor(outletActor.Get());
    renderer->AddActor(inletActor.Get());
    renderer->AddActor(outlineActor.Get());
    renderer->AddActor(streamersActor.Get());
    ...
    renderer->SetActiveCamera(aCamera.Get());
