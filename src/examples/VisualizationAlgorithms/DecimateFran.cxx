...
int main(int argc, char *argv[])
{
    ...
    decimatedActor->SetTexture(texture.Get());
    ...
    originalActor->SetTexture(texture.Get());
    ...
    //
    renderer1->AddActor(originalActor.Get());
    renderer2->AddActor(decimatedActor.Get());
    ...
    renderer1->SetActiveCamera(cam1.Get());
    renderer2->SetActiveCamera(cam1.Get());
