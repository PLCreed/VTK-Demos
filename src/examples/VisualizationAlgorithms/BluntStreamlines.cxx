...
int main(int argc, char *argv[])
{
    ...
    vtkStructuredGrid *pd = dynamic_cast<vtkStructuredGrid *>(reader->GetOutput()->GetBlock(0));
    pd->GetCenter(c);
    ...
    wallActor->SetMapper(wallMap.Get());
    ...
    rake1->SetMapper(rakeMapper.Get());
    ...
    aren->AddActor(wallActor.Get());
    aren->AddActor(finActor.Get());
    aren->AddActor(rake1.Get());
