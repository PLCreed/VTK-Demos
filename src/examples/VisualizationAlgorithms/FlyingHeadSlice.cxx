...
int main(int argc, char *argv[])
{
    if (argc < 2) {
        std::cout << "Generate 2D contour lines, corresponding to tissue density, "
                  ...
                  << std::endl;
        std::cout << "The contour lines are colored by the tissue density." << std::endl;
        std::cout << "Usage: " << argv[0] << " FullHead.mhd [useContourFilter]" << std::endl;
        std::cout << "where: filename is FullHead.mhd," << std::endl;
        std::cout << "       useContourFilter = 0|1" << std::endl;
        std::cout << "Examples:" << std::endl;
        std::cout << "Contouring, using vtkFlyingEdges2D: FullHead.mhd" << std::endl;
