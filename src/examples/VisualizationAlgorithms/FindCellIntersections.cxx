...
int main(int argc, char *argv[])
{
    ...
    std::cout << "startRay: " << startRay[0] << ", " << startRay[1] << ", " << startRay[2] << std::endl;
    std::cout << "endRay: " << endRay[0] << ", " << endRay[1] << ", " << endRay[2] << std::endl;
    ...
    reader->GetOutput()->GetCellData()->SetScalars(cellData.Get());
    ...
    locator->FindCellsAlongLine(startRay, endRay, 0.001, cellIds.Get());
