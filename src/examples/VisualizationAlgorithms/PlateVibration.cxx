...
int main(int argc, char *argv[])
{
    ...
    if (argc < 2) {
        ...
        std::cout << "Produces figure 6-14(a) Beam displacement from the VTK Textbook." << std::endl;
        return EXIT_FAILURE;
    }
    ...
    plateActor->SetMapper(plateMapper.Get());
    plateActor->GetProperty()->SetColor(colors->GetColor3d("PlateColor").GetData());
    ...
    outlineActor->SetMapper(spikeMapper.Get());
