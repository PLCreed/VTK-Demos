...
int main(int, char *[])
{
    ...
    theCone->AddFunction(cone.Get());
    theCone->AddFunction(vertPlane.Get());
    theCone->AddFunction(basePlane.Get());

    // Take a bite out of the ice cream.
    vtkNew<vtkImplicitBoolean> theCream;
    theCream->SetOperationTypeToDifference();
    theCream->AddFunction(iceCream.Get());
    theCream->AddFunction(bite.Get());
    ...
    theConeSample->SetImplicitFunction(theCone.Get());
    ...
    theCreamSample->SetImplicitFunction(theCream.Get());
    ...
    creamActor->SetMapper(creamMapper.Get());
