...
int main(int, char *[])
{
    ...
    coneActor->SetMapper(coneMap.Get());
    ...
    ren1->AddActor(s1Actor.Get());
    ren1->AddActor(s2Actor.Get());
    ren1->AddActor(s3Actor.Get());
    ren1->AddActor(s4Actor.Get());
    ren1->AddActor(outlineActor.Get());
    ren1->AddActor(coneActor.Get());
    ren1->AddActor(ga.Get());
