...
{
public:
    ErrorObserver() : Error(false), Warning(false), ErrorMessage(""), WarningMessage("") {}
...
int main(int, char *[])
{
    ...
    image->AddObserver(vtkCommand::ErrorEvent, errorObserver.Get());
    image->AddObserver(vtkCommand::WarningEvent, errorObserver.Get());
    image->GetCell(1);
