...
public:
    ...
    static CommandSubclass *New() { return new CommandSubclass; }
...
int main(int, char *[])
{
    ...
    programmableFilter->SetExecuteMethod(AdjustPoints, programmableFilter.Get());
    ...
    timerCallback->ProgrammableFilter = programmableFilter.Get();
