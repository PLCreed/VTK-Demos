...
void WindowModifiedCallback(vtkObject *caller, long unsigned int vtkNotUsed(eventId), void *vtkNotUsed(clientData),
...
int main(int, char *[])
{
    ...
    // m_pModifiedCallback->SetClientData(this.Get());

    renderWindow->AddObserver(vtkCommand::ModifiedEvent, m_pModifiedCallback.Get());
