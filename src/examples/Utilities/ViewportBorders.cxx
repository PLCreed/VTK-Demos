...
int main(int argc, char *argv[])
{
    ...
    if (numberOfFiles == 0) {
        std::cout << "Usage" << argv[0] << " file1 file2 file3 ... fileN e.g. v.vtk t.vtk k.vtk" << std::endl;
        return EXIT_FAILURE;
    }
    ...
    for (unsigned int i = 0; static_cast<int>(i) < numberOfFiles; ++i) {
        ...
        ViewportBorder(renderer.Get(), colors->GetColor3d("Gold").GetData(), static_cast<int>(i) == numberOfFiles - 1);
