...
void AdjustPoints2(void *arguments)
{
    ...
    programmableFilter->GetPolyDataOutput()->SetPoints(newPts.Get());
}
...
int main(int, char *[])
{
    ...
    programmableFilter->SetExecuteMethod(AdjustPoints2, programmableFilter.Get());
    ...
    timerCallback->SetClientData(programmableFilter.Get());
...
namespace
{
void TimerCallbackFunction(vtkObject *caller, long unsigned int vtkNotUsed(eventId), void *clientData,
