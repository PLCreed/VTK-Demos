...
int main(int, char *[])
{
    ...
    std::cout << "Unsorted: " << valueArray->GetValue(0) << " " << valueArray->GetValue(1) << " "
              << valueArray->GetValue(2) << std::endl;

    // Sort the array
    vtkNew<vtkSortDataArray> sortDataArray;
    sortDataArray->Sort(keyArray.Get(), valueArray.Get());

    std::cout << "Sorted: " << valueArray->GetValue(0) << " " << valueArray->GetValue(1) << " "
              << valueArray->GetValue(2) << std::endl;
