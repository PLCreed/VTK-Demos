...
int main(int, char *[])
{
    ...
    observer->Renderer = ren1.Get();
    observer->Animator = &animator;
    observer->RenWin = renWin.Get();

    cue1->AddObserver(vtkCommand::StartAnimationCueEvent, observer.Get());
    cue1->AddObserver(vtkCommand::EndAnimationCueEvent, observer.Get());
    cue1->AddObserver(vtkCommand::AnimationCueTickEvent, observer.Get());
