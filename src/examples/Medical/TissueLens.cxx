...
int main(int argc, char *argv[])
{
    ...
    skinClip->SetClipFunction(clipFunction.Get());
    skinClip->SetValue(0);
    ...
    skin->SetBackfaceProperty(backProp.Get());
    ...
    lensMapper->SetLookupTable(bwLut.Get());

    vtkNew<vtkActor> lens;
    lens->SetMapper(lensMapper.Get());
