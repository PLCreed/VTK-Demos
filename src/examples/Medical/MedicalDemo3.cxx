...
int main(int argc, char *argv[])
{
    ...
    renWin->AddRenderer(aRenderer.Get());
    ...
    outline->SetMapper(mapOutline.Get());
    ...
    sagittalColors->SetLookupTable(bwLut.Get());
    ...
    coronalColors->SetLookupTable(satLut.Get());
    ...
    aRenderer->AddActor(outline.Get());
    aRenderer->AddActor(sagittal.Get());
    aRenderer->AddActor(axial.Get());
    aRenderer->AddActor(coronal.Get());
    aRenderer->AddActor(skin.Get());
    aRenderer->AddActor(bone.Get());
    ...
    aRenderer->SetActiveCamera(aCamera.Get());
