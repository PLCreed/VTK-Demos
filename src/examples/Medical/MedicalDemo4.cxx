...
int main(int argc, char *argv[])
{
    ...
    volumeProperty->SetColor(volumeColor.Get());
    volumeProperty->SetScalarOpacity(volumeScalarOpacity.Get());
    volumeProperty->SetGradientOpacity(volumeGradientOpacity.Get());
