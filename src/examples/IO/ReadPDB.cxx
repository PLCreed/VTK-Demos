...
{
    if (argc < 2) {
        std::cerr << "Usage: " << argv[0] << " Filename(.pdb) e.g. caffeine.pdb" << std::endl;
        return EXIT_FAILURE;
    }
