...
void ViewportBorder(vtkSmartPointer<vtkRenderer> &renderer, double *color, bool last = false);
} // namespace
...
int main(int argc, char *argv[])
{
    ...
    for (auto row = 0; row < yGridDimensions; row++) {
        for (auto col = 0; col < xGridDimensions; col++) {
            ...
            ViewportBorder(renderers[index], colors->GetColor3d("SlateGray").GetData(),
