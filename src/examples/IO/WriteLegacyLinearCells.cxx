...
int main(int, char *[])
{
    ...
    uGrids.push_back(MakeUnstructuredGrid(vtkSmartPointer<vtkPentagonalPrism>::New()));
    filenames.push_back("PentagonalPrism.vtk");

    uGrids.push_back(MakeUnstructuredGrid(vtkSmartPointer<vtkHexagonalPrism>::New()));
