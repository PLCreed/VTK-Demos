...
int main(int argc, char *argv[])
{
    ...
    vtkSmartPointer<vtkLookupTable> originalLut = reader->GetOutput()->GetCellData()->GetScalars()->GetLookupTable();
    ...
    geometryActor->SetMapper(geometryMapper.Get());
    ...
    legend->SetScalarsToColors(categoricalLut.Get());
    legend->SetValues(legendValues.Get());
    ...
    placeLegend->AddItem(legend.Get());
    placeLegend->Translate(640 - 20, 480 - 12 * 16);

    vtkNew<vtkContextView> contextView;
    contextView->GetScene()->AddItem(placeLegend.Get());

    vtkSmartPointer<vtkRenderer> renderer = contextView->GetRenderer();

    vtkSmartPointer<vtkRenderWindow> renderWindow = contextView->GetRenderWindow();

    vtkNew<vtkRenderWindowInteractor> renderWindowInteractor;
    renderWindowInteractor->SetRenderWindow(renderWindow.Get());

    renderer->AddActor(geometryActor.Get());
    renderer->AddActor(labelActor.Get());
