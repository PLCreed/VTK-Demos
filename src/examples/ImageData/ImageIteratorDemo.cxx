...
int main(int, char *[])
{
    ...
    vtkImageIterator<unsigned char> it(imageData.Get(), extent);
    ...
    std::cout << "Increments: " << imageData->GetIncrements()[0] << ", " << imageData->GetIncrements()[1] << ", "
    ...
    imageViewer->SetInputData(imageData.Get());
