...
int main(int, char *[])
{
    ...
    std::cout << "Dims: "
              << " x: " << inputDims[0] << " y: " << inputDims[1] << " z: " << inputDims[2] << std::endl;
    ...
    std::cout << "Dims: "
              << " x: " << extractedDims[0] << " y: " << extractedDims[1] << " z: " << extractedDims[2] << std::endl;
    ...
    rightRenderer->AddActor(extractedActor.Get());
