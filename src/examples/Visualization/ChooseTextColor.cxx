...
void ChooseContrastingColor(double *rgbIn, double *rgbOut, const double threshold = .5,
...
int main(int argc, char *argv[])
{
    ...
    str << "Font: " << vtksys::SystemTools::GetFilenameWithoutExtension(std::string(argv[1])) << "\n"
...
namespace
{
void ChooseContrastingColor(double *rgbIn, double *rgbOut, const double threshold, const std::string &lightColor,
