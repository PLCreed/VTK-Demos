...
int main(int, char *[])
{
    ...
    renderWindowInteractor2->AddObserver(vtkCommand::KeyPressEvent, keypressCallback.Get());

    // Note: We can change actor and background colors for the second window.
    actor->GetProperty()->SetColor(colors->GetColor3d("BlanchedAlmond").GetData());
    renderer->SetBackground(colors->GetColor3d("DarkSlateGray").GetData());

    renderWindowInteractor2->SetRenderWindow(renderWindow.Get());
    renderWindow->Render();
