...
int main(int argc, char *argv[])
{
    ...
    sampledSphere->SetImplicitFunction(implicitSphere.Get());
    ...
    sampledCylinder->SetImplicitFunction(implicitCylinder.Get());
    ...
    std::cout << "Scalar range: " << probeCylinder->GetOutput()->GetScalarRange()[0] << ", "
    ...
    sphere->SetMapper(mapSphere.Get());
