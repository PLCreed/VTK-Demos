...
int main(int argc, char *argv[])
{
    ...
    style->AddObserver(vtkCommand::SelectionChangedEvent, selectionChangedCallback.Get());
...
namespace
{
void SelectionChangedCallbackFunction(vtkObject *vtkNotUsed(caller), long unsigned int vtkNotUsed(eventId),
                                      void *vtkNotUsed(clientData), void *callData)
{
    ...
    std::cout << "Start x: " << pos1X << " Start y: " << pos1Y << " End x: " << pos2X << " End y: " << pos2Y
              << std::endl;
}
