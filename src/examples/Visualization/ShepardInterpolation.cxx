...
int main(int argc, char *argv[])
{
    ...
    if (argc < 3) {
        std::cout << "Required parameters: Filename  resolution e.g. cowHead.vtp 100" << std::endl;
        return EXIT_FAILURE;
    }
    ...
    interpolator->SetInputData(polyData.Get());
    ...
    interpolator->Update();
    std::cout << "Scalar Range: " << interpolator->GetOutput()->GetScalarRange()[0] << ", "
    ...
    originalContour->SetInputData(polyData.Get());
    ...
    interpolatedActor->SetMapper(interpolatedMapper.Get());
    ...
    renderer->AddActor(interpolatedActor.Get());
