...
int main(int, char *[])
{
    ...
    sgridActor->SetMapper(sgridMapper.Get());
    ...
    renderer->AddActor(sgridActor.Get());
...
void CreateData(vtkStructuredGrid *sgrid)
{
    ...
    sgrid->GetPointData()->SetVectors(vectors.Get());
}
} // namespace
