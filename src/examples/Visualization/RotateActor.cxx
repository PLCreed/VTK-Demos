...
public:
    ...
    virtual void OnLeftButtonDown()
    {
        ...
        this->Actor->GetMatrix(m.Get());
        std::cout << "Matrix: " << endl << *m.Get() << std::endl;
...
int main(int, char *[])
{
    ...
    style->SetActor(actor.Get());

    renderWindowInteractor->SetInteractorStyle(style.Get());

    // Add the actor to the scene
    renderer->AddActor(actor.Get());
    renderer->SetBackground(colors->GetColor3d("DarkSlateGray").GetData()); // white
