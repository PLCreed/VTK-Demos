...
int main(int, char *[])
{
    ...
    polydataToProcess->SetPoints(points.Get());
    polydataToProcess->GetPointData()->SetScalars(values.Get());

    vtkNew<vtkPolyData> polydataToVisualize;
    polydataToVisualize->SetPoints(points.Get());
    polydataToVisualize->GetPointData()->SetScalars(vertexColors.Get());

    vtkNew<vtkVertexGlyphFilter> vertexGlyphFilter;
    vertexGlyphFilter->AddInputData(polydataToVisualize.Get());
    ...
    vertsActor->SetMapper(vertsMapper.Get());
    ...
    shepard->SetInputData(polydataToProcess.Get());
    ...
    contourActor->SetMapper(contourMapper.Get());
    ...
    contourMapper->SetLookupTable(lut.Get());
    ...
    renderer->AddActor(vertsActor.Get());
