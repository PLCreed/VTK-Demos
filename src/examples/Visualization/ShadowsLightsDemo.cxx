...
int main(int, char *[])
{
    ...
    rectangleActor->SetMapper(rectangleMapper.Get());
    ...
    boxActor->SetMapper(boxMapper.Get());
    ...
    renderer->AddViewProp(rectangleActor.Get());
    renderer->AddViewProp(boxActor.Get());
    renderer->AddViewProp(coneActor.Get());
    ...
    l2->PositionalOn();
    renderer->AddLight(l2.Get());
    l2->SwitchOn();

    AddLightActors(renderer.Get());
