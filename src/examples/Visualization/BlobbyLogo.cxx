...
int main(int argc, char *argv[])
{
    ...
    aRenderWindow->AddRenderer(aRenderer.Get());
    aRenderWindow->SetWindowName("BlobbyLogo");

    vtkNew<vtkRenderWindowInteractor> anInteractor;
    anInteractor->SetRenderWindow(aRenderWindow.Get());
    ...
    VTransformFilter->SetTransform(VTransform.Get());
    ...
    TTransformFilter->SetTransform(TTransform.Get());
    ...
    KTransformFilter->SetTransform(KTransform.Get());
    ...
    blobbyLogo->SetMapper(blobbyLogoMapper.Get());
    blobbyLogo->SetProperty(banana.Get());
    ...
    logo->SetProperty(tomato.Get());
    logo->SetPosition(0, 0, 6);

    aRenderer->AddActor(logo.Get());
    aRenderer->AddActor(blobbyLogo.Get());
