...
int main(int, char *[])
{
    ...
    MakeLUT(tableSize, lut1.Get());
    MakeLUTFromCTF(tableSize, lut2.Get());
    ...
    MakeCellData(tableSize, lut2.Get(), colorData2.Get());
    plane12->GetOutput()->GetCellData()->SetScalars(colorData2.Get());
    ...
    // mapper11->SetLookupTable(lut1.Get());
    ...
    actor11->SetMapper(mapper11.Get());
    vtkNew<vtkActor> actor12;
    actor12->SetMapper(mapper12.Get());
    ...
    actor21->SetMapper(mapper11.Get());
    ...
    actor22->SetMapper(mapper22.Get());
    ...
    renWin->AddRenderer(ren11.Get());
    renWin->AddRenderer(ren12.Get());
    renWin->AddRenderer(ren21.Get());
    renWin->AddRenderer(ren22.Get());
    ...
    ren11->AddActor(actor11.Get());
    ren12->AddActor(actor12.Get());
    ren21->AddActor(actor21.Get());
    ren22->AddActor(actor22.Get());
