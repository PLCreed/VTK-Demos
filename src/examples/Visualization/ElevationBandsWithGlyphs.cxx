...
int main(int, char *[])
{
    ...
    auto scalarRange = source->GetPointData()->GetScalars("Elevation")->GetRange();
...
vtkSmartPointer<vtkLookupTable> GetCategoricalLUT()
{
    ...
    colorSeries->BuildLookupTable(lut.Get(), vtkColorSeries::CATEGORICAL);
