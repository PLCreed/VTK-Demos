...
int main(int, char *[])
{
    ...
    polydata->GetPointData()->AddArray(colors.Get());
    polydata->GetPointData()->AddArray(scaleFactors.Get());
    ...
    glyph3Dmapper->SetInputData(polydata.Get());
    ...
    actor->SetMapper(glyph3Dmapper.Get());
