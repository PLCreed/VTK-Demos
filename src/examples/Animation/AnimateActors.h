...
public:
    ...
    void SetStartPosition(const vtkVector3d &position) { this->StartPosition = position; }

    void SetEndPosition(const vtkVector3d &position) { this->EndPosition = position; }
...
private:
     ...
     */
    void Start() { this->Actor->SetPosition(this->StartPosition.GetData()); }
    ...
    void End() { this->Actor->SetPosition(this->EndPosition.GetData()); }
