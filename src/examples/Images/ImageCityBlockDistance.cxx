...
int main(int argc, char *argv[])
{
    ...
    distanceActor->GetMapper()->SetInputConnection(distanceCastFilter->GetOutputPort());
    ...
    distanceRenderer->AddActor(distanceActor.Get());
    ...
    renderWindow->AddRenderer(distanceRenderer.Get());
