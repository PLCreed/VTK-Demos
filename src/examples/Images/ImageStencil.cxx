...
int main(int, char *[])
{
    ...
    CreateColorImage(image1.Get(), 0); // Create a red image

    vtkNew<vtkImageData> image2;
    CreateColorImage(image2.Get(), 1); // Create a green image
    ...
    imageToImageStencil->SetInputData(mask.Get());
    ...
    stencil->SetBackgroundInputData(image2.Get());
    stencil->SetInputData(image1.Get());
    stencil->Update();
