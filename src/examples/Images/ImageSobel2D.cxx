...
int main(int, char *[])
{
    ...
    sobelActor->SetMapper(sobelMapper.Get());
    ...
    sobelRenderer->AddActor(sobelActor.Get());
    ...
    renderWindow->AddRenderer(xRenderer.Get());
    renderWindow->AddRenderer(yRenderer.Get());
    renderWindow->AddRenderer(sobelRenderer.Get());
