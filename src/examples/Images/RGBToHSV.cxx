...
int main(int argc, char *argv[])
{
    ...
    sActor->GetMapper()->SetInputConnection(extractSaturationFilter->GetOutputPort());
    ...
    vRenderer->AddActor(vActor.Get());
    vRenderer->SetActiveCamera(sharedCamera.Get());
    ...
    renderWindow->AddRenderer(vRenderer.Get());
