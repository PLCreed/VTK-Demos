...
int main(int argc, char *argv[])
{
    ...
    renderWindow->AddRenderer(edgeRenderer.Get());
    ...
    originalRenderer->AddActor(imageActor.Get());
    ...
    planeActor->SetMapper(dsm.Get());
    planeActor->GetProperty()->SetAmbient(1.0);
    planeActor->GetProperty()->SetDiffuse(0.0);
    planeActor->GetProperty()->SetColor(colors->GetColor3d("GhostWhite").GetData());

    // Add the actors to the renderer, set the background and size
    edgeRenderer->AddActor(planeActor.Get());
