...
int main(int argc, char *argv[])
{
    ...
    std::cout << "Original dimensions: " << imageData->GetDimensions()[0] << ", " << imageData->GetDimensions()[1]
              << std::endl;
    newSize[0] = imageData->GetDimensions()[0] * factor;
    newSize[1] = imageData->GetDimensions()[1] * factor;
    std::cout << "New dimensions: " << newSize[0] << ", " << newSize[1] << std::endl;
    ...
    for (int i = -1; i <= 10; ++i) {
        ...
        resize->SetInputData(imageData.Get());
        resize->SetInterpolator(interpolator.Get());
