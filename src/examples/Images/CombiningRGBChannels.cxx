...
int main(int, char *[])
{
    ...
    redRenderer->AddActor(redActor.Get());
    ...
    greenRenderer->AddActor(greenActor.Get());
    ...
    blueRenderer->AddActor(blueActor.Get());
    ...
    combinedRenderer->AddActor(combinedActor.Get());
    ...
    renderWindow->AddRenderer(redRenderer.Get());
    renderWindow->AddRenderer(greenRenderer.Get());
    renderWindow->AddRenderer(blueRenderer.Get());
    renderWindow->AddRenderer(combinedRenderer.Get());
