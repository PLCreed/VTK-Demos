...
int main(int argc, char *argv[])
{
    ...
    if (argc < 2) {
        std::cout << "Required arguments: BinaryImage.png e.g. Yinyang.png" << std::endl;
        return EXIT_FAILURE;
    }
    ...
    convolutionFilter->SetXKernel(xKernel.Get());
    ...
    convolutionActor->GetMapper()->SetInputConnection(convolutionCastFilter->GetOutputPort());
    ...
    convolutionRenderer->AddActor(convolutionActor.Get());
    ...
    renderWindow->AddRenderer(convolutionRenderer.Get());
