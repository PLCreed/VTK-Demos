...
int main(int, char *[])
{
    ...
    islandRemovalActor->GetMapper()->SetInputConnection(islandRemovalFilter->GetOutputPort());
    ...
    islandRemovalRenderer->AddActor(islandRemovalActor.Get());
    islandRemovalRenderer->ResetCamera();
    islandRemovalRenderer->SetBackground(colors->GetColor3d("SteelBlue").GetData());

    vtkNew<vtkRenderWindow> renderWindow;
    renderWindow->SetSize(600, 300);
    renderWindow->AddRenderer(originalRenderer.Get());
    renderWindow->AddRenderer(islandRemovalRenderer.Get());
