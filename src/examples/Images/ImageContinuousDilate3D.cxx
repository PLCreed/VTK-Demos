...
int main(int argc, char *argv[])
{
    ...
    dilateFilter->SetInputData(image.Get());
    dilateFilter->SetKernelSize(10, 10, 1);
    dilateFilter->Update();

    vtkNew<vtkDataSetMapper> originalMapper;
    originalMapper->SetInputData(image.Get());
    ...
    dilatedActor->SetMapper(dilatedMapper.Get());
    ...
    rightRenderer->AddActor(dilatedActor.Get());
