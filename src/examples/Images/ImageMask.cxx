...
int main(int, char *[])
{
    ...
    maskRenderer->AddActor(maskActor.Get());
    ...
    maskedRenderer->AddActor(maskedActor.Get());
    ...
    inverseMaskedRenderer->AddActor(inverseMaskedActor.Get());
    ...
    renderWindow->AddRenderer(maskRenderer.Get());
    renderWindow->AddRenderer(maskedRenderer.Get());
    renderWindow->AddRenderer(inverseMaskedRenderer.Get());
