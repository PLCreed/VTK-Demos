...
int main(int argc, char *argv[])
{
    ...
    imageActor->SetInputData(imageData.Get());
    ...
    superquadricActor->GetProperty()->SetColor(colors->GetColor3d("NavajoWhite").GetData());
    ...
    renderWindow->AddRenderer(backgroundRenderer.Get());
    renderWindow->AddRenderer(sceneRenderer.Get());
    ...
    sceneRenderer->AddActor(superquadricActor.Get());
    backgroundRenderer->AddActor(imageActor.Get());
