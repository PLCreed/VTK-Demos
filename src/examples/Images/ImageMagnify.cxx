...
int main(int argc, char *argv[])
{
    ...
    magnifiedActor->GetMapper()->SetInputConnection(changeFilter->GetOutputPort());
    ...
    magnifiedRenderer->AddActor(magnifiedActor.Get());
    ...
    renderWindow->AddRenderer(magnifiedRenderer.Get());
