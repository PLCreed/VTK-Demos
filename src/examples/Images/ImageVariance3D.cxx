...
int main(int, char *[])
{
    ...
    varianceActor->GetMapper()->SetInputConnection(varianceCastFilter->GetOutputPort());
    ...
    varianceRenderer->AddActor(varianceActor.Get());
    ...
    renderWindow->AddRenderer(varianceRenderer.Get());
