...
int main(int, char *[])
{
    ...
    originalSlice->SetMapper(originalSliceMapper.Get());
    ...
    shiftScaleFilter->SetShift(-1.0f
                               * extractRealFilter->GetOutput()->GetScalarRange()[0]); // brings the lower bound to 0
    float oldRange =
        extractRealFilter->GetOutput()->GetScalarRange()[1] - extractRealFilter->GetOutput()->GetScalarRange()[0];
    ...
    highPassSlice->SetMapper(highPassSliceMapper.Get());
    ...
    originalRenderer->AddViewProp(originalSlice.Get());
    ...
    highPassRenderer->AddViewProp(highPassSlice.Get());
    ...
    renderWindow->AddRenderer(highPassRenderer.Get());
