...
int main(int, char *[])
{
    ...
    convolvedActor->GetMapper()->SetInputConnection(convolvedCastFilter->GetOutputPort());
    ...
    convolvedRenderer->AddActor(convolvedActor.Get());
    ...
    renderWindow->AddRenderer(convolvedRenderer.Get());
