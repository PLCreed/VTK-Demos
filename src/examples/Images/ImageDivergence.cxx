...
int main(int, char *[])
{
    ...
    originalActor->GetMapper()->SetInputConnection(originalCastFilter->GetOutputPort());

    vtkNew<vtkImageActor> divergenceActor;
    divergenceActor->GetMapper()->SetInputConnection(divergenceCastFilter->GetOutputPort());
    ...
    divergenceRenderer->AddActor(divergenceActor.Get());
    ...
    renderWindow->AddRenderer(divergenceRenderer.Get());
