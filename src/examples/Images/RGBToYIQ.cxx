...
int main(int argc, char *argv[])
{
    ...
    yRenderer->SetActiveCamera(sharedCamera.Get());
    ...
    qRenderer->AddActor(qActor.Get());
    qRenderer->SetActiveCamera(sharedCamera.Get());
    ...
    renderWindow->AddRenderer(qRenderer.Get());
