...
int main(int argc, char *argv[])
{
    ...
    freeType->RenderString(textProperty.Get(), text, 70, textImage.Get());

    // Combine the images
    vtkNew<vtkImageBlend> blend;
    blend->AddInputConnection(drawing->GetOutputPort());
    blend->AddInputData(textImage.Get());
    ...
    blendRenderer->AddActor(blendActor.Get());
    ...
    renderWindow->AddRenderer(blendRenderer.Get());
