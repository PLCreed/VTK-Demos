...
int main(int, char *[])
{
    ...
    // writer->SetInputData(image1.Get());
    ...
    dotProductFilter->SetInput1Data(image1.Get());
    dotProductFilter->SetInput2Data(image2.Get());
    ...
    leftRenderer->AddActor(actor1.Get());
    centerRenderer->AddActor(actor2.Get());
    rightRenderer->AddActor(dotProductActor.Get());
