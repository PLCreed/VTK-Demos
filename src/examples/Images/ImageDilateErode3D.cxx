...
int main(int argc, char *argv[])
{
    ...
    if (argc < 2) {
        std::cout << "Required arguments: filename.png e.g. Yinyang.png" << std::endl;
        return EXIT_FAILURE;
    }
    ...
    dilateErodeRenderer->AddActor(openCloseActor.Get());
    ...
    renderWindow->AddRenderer(dilateErodeRenderer.Get());
