...
int main(int, char *[])
{
    ...
    correlationActor->GetMapper()->SetInputConnection(correlationCastFilter->GetOutputPort());
    ...
    kernelRenderer->AddActor(kernelActor.Get());
    ...
    correlationRenderer->AddActor(correlationActor.Get());
    ...
    renderWindow->AddRenderer(kernelRenderer.Get());
    renderWindow->AddRenderer(correlationRenderer.Get());
