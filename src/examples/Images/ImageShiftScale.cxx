...
int main(int, char *[])
{
    ...
    CreateImage(image.Get());

    vtkNew<vtkImageShiftScale> shiftScaleFilter;
    shiftScaleFilter->SetOutputScalarTypeToUnsignedChar();
    shiftScaleFilter->SetInputData(image.Get());
    ...
    originalSliceMapper->SetInputData(image.Get());
    ...
    shiftScaleSlice->SetMapper(shiftScaleMapper.Get());
    ...
    shiftScaleRenderer->AddViewProp(shiftScaleSlice.Get());
    ...
    renderWindow->AddRenderer(shiftScaleRenderer.Get());
