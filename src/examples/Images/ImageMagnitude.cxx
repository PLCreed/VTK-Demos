...
int main(int, char *[])
{
    ...
    magnitudeActor->GetMapper()->SetInputConnection(magnitudeFilter->GetOutputPort());
    ...
    magnitudeRenderer->AddActor(magnitudeActor.Get());
    ...
    renderWindow->AddRenderer(magnitudeRenderer.Get());
