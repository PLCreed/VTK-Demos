...
int main(int argc, char *argv[])
{
    ...
    isoSmoothedActor->SetMapper(isoSmoothedMapper.Get());
    isoSmoothedActor->GetProperty()->SetColor(colors->GetColor3d("Ivory").GetData());
    ...
    isoActor->SetMapper(isoMapper.Get());
    ...
    rendererLeft->AddActor(isoActor.Get());
    rendererRight->AddActor(isoSmoothedActor.Get());
