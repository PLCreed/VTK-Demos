...
int main(int argc, char *argv[])
{
    ...
    constantPadActor->GetMapper()->SetInputConnection(constantPadColor->GetOutputPort());
    ...
    mirrorPadActor->GetMapper()->SetInputConnection(mirrorPadColor->GetOutputPort());
    ...
    constantPadRenderer->AddActor(constantPadActor.Get());
    ...
    mirrorPadRenderer->AddActor(mirrorPadActor.Get());
    ...
    renderWindow->AddRenderer(constantPadRenderer.Get());
    renderWindow->AddRenderer(mirrorPadRenderer.Get());
