...
int main(int argc, char *argv[])
{
    ...
    if (argc < 2) {
        std::cout << "Usage: " << argv[0] << " Filename e.g. fullhead15.png" << std::endl;
        return EXIT_FAILURE;
    }
    ...
    idealRenderer->AddActor(idealActor.Get());
    ...
    butterworthRenderer->AddActor(butterworthActor.Get());
    ...
    renderWindow->AddRenderer(idealRenderer.Get());
    renderWindow->AddRenderer(butterworthRenderer.Get());
