...
void CreateImageActor(vtkImageActor *actor, double colorWindow, double colorLevel);
}
...
int main(int argc, char *argv[])
{
    ...
    CreateImageActor(compressedActor.Get(), 160, 120);
    ...
    compressedRenderer->AddActor(compressedActor.Get());
    ...
    renderWindow->AddRenderer(compressedRenderer.Get());
