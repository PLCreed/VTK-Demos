...
int main(int argc, char *argv[])
{
    ...
    laplacianRenderer->AddActor(laplacianActor.Get());
    vtkNew<vtkRenderer> enhancedRenderer;
    enhancedRenderer->AddActor(enhancedActor.Get());

    std::vector<vtkSmartPointer<vtkRenderer>> renderers;
    renderers.push_back(originalRenderer.Get());
    renderers.push_back(laplacianRenderer.Get());
    renderers.push_back(enhancedRenderer.Get());
