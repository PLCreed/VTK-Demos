...
namespace
{
void CreateImage(vtkImageData *const image, vtkMinimalStandardRandomSequence *rng);
}
...
int main(int, char *[])
{
    ...
    std::cout << "New range: [" << shiftScaleFilter->GetOutput()->GetScalarRange()[0] << ", "
              << shiftScaleFilter->GetOutput()->GetScalarRange()[1] << "]" << std::endl;
