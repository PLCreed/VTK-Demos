...
int main(int argc, char *argv[])
{
    ...
    XActor->SetMapper(XTextMapper.Get());
    ...
    YActor->SetMapper(YTextMapper.Get());
    ...
    ZActor->SetMapper(ZTextMapper.Get());
    ...
    renderer->AddActor(XActor.Get());
    renderer->AddActor(YActor.Get());
    renderer->AddActor(ZActor.Get());
    ...
    XActor->SetCamera(camera.Get());
    YActor->SetCamera(camera.Get());
    ZActor->SetCamera(camera.Get());
