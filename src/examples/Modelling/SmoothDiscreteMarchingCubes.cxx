...
int main(int /* argc */, char * /* argv */[])
{
    ...
    discrete->SetInputData(blob.Get());
...
vtkSmartPointer<vtkImageData> MakeBlob(int n, double radius)
{
    vtkSmartPointer<vtkImageData> blobImage = vtkSmartPointer<vtkImageData>::New();
    ...
    for (int i = 0; i < n; ++i) {
        ...
        sampler->SetImplicitFunction(sphere.Get());
        ...
        maxValue->SetInputData(0, blobImage.Get());
