 ...
 */
std::vector<std::array<double, 3>> GetLine(double const &angle, double const &step, double const &radius,
...
int main(int argc, char *argv[])
{
    ...
    extrude->SetInputData(polydata.Get());
    ...
    lineMapper->SetInputData(polydata.Get());
    ...
    ren->AddActor(surfaceActor.Get());
    if (showLine) {
        ren->AddActor(lineActor.Get());
    }
