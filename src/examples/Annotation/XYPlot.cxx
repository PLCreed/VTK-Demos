...
int main(int argc, char *argv[])
{
    ...
    renderer2->AddActor2D(xyplot.Get());
    renderer2->AddActor2D(xyplot2.Get());
    renderer2->AddActor2D(xyplot3.Get());
