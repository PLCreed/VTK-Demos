...
public:
    ...
    HighlightInteractorStyle() : vtkInteractorStyleRubberBandPick()
    {
        ...
        this->SelectedActor->SetMapper(SelectedMapper.Get());
    }
    ...
    virtual void OnLeftButtonUp() override
    {
        ...
        if (this->CurrentMode == VTKISRBP_SELECT) {
            ...
            std::cout << "Extracted " << extractPolyDataGeometry->GetOutput()->GetNumberOfCells() << " cells."
                      << std::endl;
            ...
            this->GetInteractor()->GetRenderWindow()->GetRenderers()->GetFirstRenderer()->AddActor(SelectedActor.Get());
...
int main(int argc, char *argv[])
{
    ...
    idFilter->SetInputData(polyData.Get());
#if VTK890
