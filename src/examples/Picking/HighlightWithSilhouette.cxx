...
public:
    ...
    void SetSilhouette(vtkPolyDataSilhouette *silhouette) { this->Silhouette = silhouette; }

    void SetSilhouetteActor(vtkActor *silhouetteActor) { this->SilhouetteActor = silhouetteActor; }
...
int main(int argc, char *argv[])
{
    ...
    silhouetteActor->SetMapper(silhouetteMapper.Get());
    ...
    style->SetDefaultRenderer(renderer.Get());
    style->SetSilhouetteActor(silhouetteActor.Get());
    style->SetSilhouette(silhouette.Get());
