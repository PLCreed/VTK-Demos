...
int main(int, char *[])
{
    ...
    sphereActor->GetProperty()->SetColor(namedColors->GetColor3d("Banana").GetData());
    ...
    assembly->AddPart(sphereActor.Get());
    assembly->AddPart(cubeActor.Get());
    ...
    renderer->AddActor(assembly.Get());
