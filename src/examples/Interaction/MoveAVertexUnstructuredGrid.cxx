...
public:
    ...
    InteractorStyleMoveVertex()
    {
        ...
        this->MovePolyData->SetPoints(points.Get());
        ...
        this->MoveActor->GetProperty()->SetColor(this->color->GetColor3d("Pink").GetData());
    }
...
int main(int, char *[])
{
    ...
    glyphFilter->SetInputData(input.Get());
    glyphFilter->Update();
