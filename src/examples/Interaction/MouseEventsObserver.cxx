...
int main(int, char *[])
{
    ...
    renderWindowInteractor->AddObserver(vtkCommand::RightButtonPressEvent, clickCallback.Get());
    renderWindowInteractor->AddObserver(vtkCommand::KeyPressEvent, clickCallback.Get());
