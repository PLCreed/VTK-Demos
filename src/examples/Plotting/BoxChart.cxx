...
int main(int, char *[])
{
    ...
    for (int i = 0; i < numParam; i++) {
        ...
        inputBoxPlotTable->AddColumn(arrIndex.Get());
    }
    ...
    quartiles->SetInputData(vtkStatisticsAlgorithm::INPUT_DATA, inputBoxPlotTable.Get());
    quartiles->Update();
    ...
    chart->GetPlot(0)->SetLabels(labels.Get());
