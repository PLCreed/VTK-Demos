...
std::string month_labels[] = {"Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"};
constexpr int book[] = {5675, 5902, 6388, 5990, 5575, 7393, 9878, 8082, 6417, 5946, 5526, 5166};
constexpr int new_popular[] = {701, 687, 736, 696, 750, 814, 923, 860, 786, 735, 680, 741};
constexpr int periodical[] = {184, 176, 166, 131, 171, 191, 231, 166, 197, 162, 152, 143};
constexpr int audiobook[] = {903, 1038, 987, 1073, 1144, 1203, 1173, 1196, 1213, 1076, 926, 874};
constexpr int video[] = {1524, 1565, 1627, 1445, 1179, 1816, 2293, 1811, 1588, 1561, 1542, 1563};
} // namespace
...
int main(int, char *[])
{
    ...
    chart->GetAxis(1)->SetCustomTickPositions(arrXTickPositions.Get(), arrMonthLabel.Get());
    ...
    stack->SetColorSeries(colorSeries.Get());
