...
std::string labels[] = {"Books", "New and Popular", "Periodical", "Audiobook", "Video"};
} // namespace
...
int main(int, char *[])
{
    ...
    pie->SetColorSeries(colorSeries.Get());
    pie->SetInputData(table.Get());
    pie->SetInputArray(0, "2008 Circulation");
    pie->SetLabels(labelArray.Get());
