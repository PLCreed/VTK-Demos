...
int main(int, char *[])
{
    ...
    area->GetBrush()->SetColorF(color3d.GetRed(), color3d.GetGreen(), color3d.GetBlue(), 0.6);
#else
    area->GetBrush()->SetColor(color3d.GetRed(), color3d.GetGreen(), color3d.GetBlue(), 0.6);
#endif
