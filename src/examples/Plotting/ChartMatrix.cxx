...
int main(int, char *[])
{
    ...
    view->GetScene()->AddItem(matrix.Get());
    ...
    plot->SetInputData(table.Get(), 0, 1);
...
#else
    plot->GetXAxis()->GetGridPen()->SetColor(colors->GetColor4ub("warm_grey").GetData());
    plot->GetYAxis()->GetGridPen()->SetColor(colors->GetColor4ub("warm_grey").GetData());
#endif
    plot->SetColor(colors->GetColor3ub("sea_green").GetRed(), colors->GetColor3ub("sea_green").GetGreen(),
    ...
    plot->SetInputData(table.Get(), 0, 2);
#if VTK_HAS_SETCOLORF
    plot->GetXAxis()->GetGridPen()->SetColorF(colors->GetColor3d("warm_grey").GetData());
    plot->GetYAxis()->GetGridPen()->SetColorF(colors->GetColor3d("warm_grey").GetData());
#else
    ...
    plot->GetYAxis()->GetGridPen()->SetColor(colors->GetColor4ub("warm_grey").GetData());
#endif
    plot->SetColor(colors->GetColor3ub("rose_madder").GetRed(), colors->GetColor3ub("rose_madder").GetGreen(),
                   colors->GetColor3ub("rose_madder").GetBlue(), 255);

    //
    chart = matrix->GetChart(vtkVector2i(1, 0));
    plot = chart->AddPlot(vtkChart::LINE);
    plot->SetInputData(table.Get(), 0, 3);
#if VTK_HAS_SETCOLORF
    plot->GetXAxis()->GetGridPen()->SetColorF(colors->GetColor3d("warm_grey").GetData());
    plot->GetYAxis()->GetGridPen()->SetColorF(colors->GetColor3d("warm_grey").GetData());
#else
    ...
    plot->GetYAxis()->GetGridPen()->SetColor(colors->GetColor4ub("warm_grey").GetData());
#endif
    plot->SetColor(colors->GetColor3ub("dark_orange").GetRed(), colors->GetColor3ub("dark_orange").GetGreen(),
    ...
    plot->SetInputData(table.Get(), 0, 4);
#if VTK_HAS_SETCOLORF
    plot->GetXAxis()->GetGridPen()->SetColorF(colors->GetColor3d("warm_grey").GetData());
    plot->GetYAxis()->GetGridPen()->SetColorF(colors->GetColor3d("warm_grey").GetData());
#else
    ...
    plot->GetYAxis()->GetGridPen()->SetColor(colors->GetColor4ub("warm_grey").GetData());
#endif
    plot->SetColor(colors->GetColor3ub("burnt_sienna").GetRed(), colors->GetColor3ub("burnt_sienna").GetGreen(),
    ...
    plot->GetYAxis()->GetGridPen()->SetColor(colors->GetColor4ub("warm_grey").GetData());
#endif
    plot->SetColor(colors->GetColor3ub("royal_blue").GetRed(), colors->GetColor3ub("royal_blue").GetGreen(),
