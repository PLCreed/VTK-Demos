...
constexpr int book_2008[] = {5675, 5902, 6388, 5990, 5575, 7393, 9878, 8082, 6417, 5946, 5526, 5166};
constexpr int new_popular_2008[] = {701, 687, 736, 696, 750, 814, 923, 860, 786, 735, 680, 741};
constexpr int periodical_2008[] = {184, 176, 166, 131, 171, 191, 231, 166, 197, 162, 152, 143};
constexpr int audiobook_2008[] = {903, 1038, 987, 1073, 1144, 1203, 1173, 1196, 1213, 1076, 926, 874};
constexpr int video_2008[] = {1524, 1565, 1627, 1445, 1179, 1816, 2293, 1811, 1588, 1561, 1542, 1563};

constexpr int book_2009[] = {6388, 5990, 5575, 9878, 8082, 5675, 7393, 5902, 5526, 5166, 5946, 6417};
constexpr int new_popular_2009[] = {696, 735, 786, 814, 736, 860, 750, 687, 923, 680, 741, 701};
constexpr int periodical_2009[] = {197, 166, 176, 231, 171, 152, 166, 131, 184, 191, 143, 162};
constexpr int audiobook_2009[] = {1213, 1076, 926, 987, 903, 1196, 1073, 1144, 1203, 1038, 874, 1173};
constexpr int video_2009[] = {2293, 1561, 1542, 1627, 1588, 1179, 1563, 1445, 1811, 1565, 1524, 1816};
...
int main(int, char *[])
{
    ...
    build_array("Month", arrMonth.Get(), month);
    table->AddColumn(arrMonth.Get());

    vtkNew<vtkIntArray> arrBooks2008;
    build_array("Books 2008", arrBooks2008.Get(), book_2008);
    table->AddColumn(arrBooks2008.Get());
    vtkNew<vtkIntArray> arrNewPopular2008;
    build_array("New / Popular 2008", arrNewPopular2008.Get(), new_popular_2008);
    table->AddColumn(arrNewPopular2008.Get());
    vtkNew<vtkIntArray> arrPeriodical2008;
    build_array("Periodical 2008", arrPeriodical2008.Get(), periodical_2008);
    table->AddColumn(arrPeriodical2008.Get());
    vtkNew<vtkIntArray> arrAudiobook2008;
    build_array("Audiobook 2008", arrAudiobook2008.Get(), audiobook_2008);
    table->AddColumn(arrAudiobook2008.Get());
    vtkNew<vtkIntArray> arrVideo2008;
    build_array("Video 2008", arrVideo2008.Get(), video_2008);
    table->AddColumn(arrVideo2008.Get());

    vtkNew<vtkIntArray> arrBooks2009;
    build_array("Books 2009", arrBooks2009.Get(), book_2009);
    table->AddColumn(arrBooks2009.Get());
    vtkNew<vtkIntArray> arrNewPopular2009;
    build_array("New / Popular 2009", arrNewPopular2009.Get(), new_popular_2009);
    table->AddColumn(arrNewPopular2009.Get());
    vtkNew<vtkIntArray> arrPeriodical2009;
    build_array("Periodical 2009", arrPeriodical2009.Get(), periodical_2009);
    table->AddColumn(arrPeriodical2009.Get());
    vtkNew<vtkIntArray> arrAudiobook2009;
    build_array("Audiobook 2009", arrAudiobook2009.Get(), audiobook_2009);
    table->AddColumn(arrAudiobook2009.Get());
    vtkNew<vtkIntArray> arrVideo2009;
    build_array("Video 2009", arrVideo2009.Get(), video_2009);
    table->AddColumn(arrVideo2009.Get());
    ...
    bar->SetColorSeries(colorSeries1.Get());
    bar->SetInputData(table.Get(), "Month", "Books 2008");
    ...
    bar = dynamic_cast<vtkPlotBar *>(chart->AddPlot(vtkChart::BAR));
    bar->SetColorSeries(colorSeries2.Get());
    bar->SetInputData(table.Get(), "Month", "Books 2009");
    ...
    axis->SetCustomTickPositions(dates.Get(), strings.Get());
