...
int main(int, char *[])
{
    ...
    fit->SetImplicitFunction(sphere.Get());
    fit->SetThreshold(0.01);
    fit->Update();
    std::cout << fit->GetOutput()->GetNumberOfPoints() << " out of " << points->GetNumberOfPoints()
              << " points are within " << fit->GetThreshold() << " of the implicit function" << std::endl;
