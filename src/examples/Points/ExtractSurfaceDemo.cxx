...
int main(int argc, char *argv[])
{
    ...
    if (polyData->GetPointData()->GetNormals()) {
        ...
        distance->SetInputData(polyData.Get());
    } else {
    ...
    surfaceActor->SetBackfaceProperty(backProp.Get());
    ...
    glyph3DActor->GetProperty()->SetColor(colors->GetColor3d("MidnightBlue").GetData());
    ...
    //
    ren1->AddActor(surfaceActor.Get());
    ren1->AddActor(glyph3DActor.Get());
