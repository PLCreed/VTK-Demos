...
int main(int argc, char *argv[])
{
    ...
    removal->SetInputData(polyData.Get());
    ...
    glyph3DActor1->SetMapper(glyph3DMapper1.Get());
    ...
    glyph3DActor2->SetMapper(glyph3DMapper2.Get());
    ...
    //
    ren1->AddActor(glyph3DActor1.Get());
    ren1->AddActor(glyph3DActor2.Get());
