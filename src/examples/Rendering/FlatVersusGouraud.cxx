...
int main(int argc, char *argv[])
{
    ...
    renderers.push_back(flatSphereRenderer.Get());
    vtkNew<vtkRenderer> flatCylinderRenderer;
    renderers.push_back(flatCylinderRenderer.Get());
    vtkNew<vtkRenderer> flatIsoSurfaceRenderer;
    renderers.push_back(flatIsoSurfaceRenderer.Get());
    vtkNew<vtkRenderer> flatModelRenderer;
    renderers.push_back(flatModelRenderer.Get());
    vtkNew<vtkRenderer> smoothSphereRenderer;
    renderers.push_back(smoothSphereRenderer.Get());
    vtkNew<vtkRenderer> smoothCylinderRenderer;
    renderers.push_back(smoothCylinderRenderer.Get());
    vtkNew<vtkRenderer> smoothIsoSurfaceRenderer;
    renderers.push_back(smoothIsoSurfaceRenderer.Get());
    vtkNew<vtkRenderer> smoothModelRenderer;
    renderers.push_back(smoothModelRenderer.Get());

    // Add the actors
    CreateSphere(flatSphereRenderer.Get(), true);
    CreateCylinder(flatCylinderRenderer.Get(), true);
    CreateIsoSurface(flatIsoSurfaceRenderer.Get(), true);
    CreateModel(flatModelRenderer.Get(), true, argv[1]);

    CreateSphere(smoothSphereRenderer.Get(), false);
    CreateCylinder(smoothCylinderRenderer.Get(), false);
    CreateIsoSurface(smoothIsoSurfaceRenderer.Get(), false);
    CreateModel(smoothModelRenderer.Get(), false, argv[1]);
