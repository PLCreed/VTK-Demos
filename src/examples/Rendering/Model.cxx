...
int main(int, char *[])
{
    ...
    std::array<unsigned char, 4> cubeColor {
        {250, 128, 114, 255}
    };
    ...
    ren2->AddActor(sphereActor.Get());
    ren3->AddActor(cubeActor.Get());
