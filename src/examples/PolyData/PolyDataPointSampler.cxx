...
int main(int argc, char *argv[])
{
    ...
    sample->SetInputData(polyData.Get());
    ...
    originalGlyph3D->SetInputData(polyData.Get());
    ...
    sampleActor->SetMapper(sampleMapper.Get());
    ...
    //
    ren1->AddActor(originalActor.Get());
    ren1->AddActor(sampleActor.Get());
