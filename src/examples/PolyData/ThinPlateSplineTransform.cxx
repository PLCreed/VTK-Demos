...
int main(int argc, char *argv[])
{
    ...
    if (argc < 2) {
        std::cerr << "Usage: " << argv[0] << " Filename.bmp e.g. masonry.bmp" << std::endl;
        return EXIT_FAILURE;
    }
    ...
    alpha->SetLookupTable(table.Get());
    ...
    transform->SetSourceLandmarks(p2.Get());
    transform->SetTargetLandmarks(p1.Get());
    ...
    act->SetMapper(map.Get());

    vtkNew<vtkRenderer> renderer;
    renderer->AddActor(act.Get());
