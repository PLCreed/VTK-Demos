...
int main(int, char *[])
{
    ...
    polydata->GetPointData()->AddArray(floatArray.Get());
    ...
    polydata->GetPointData()->AddArray(intArray.Get());

    for (vtkIdType i = 0; i < 3; i++) {
        double p[3];
        polydata->GetPoint(i, p);
        vtkFloatArray *pointsFloatArray =
            dynamic_cast<vtkFloatArray *>(polydata->GetPointData()->GetArray("FloatArray"));
