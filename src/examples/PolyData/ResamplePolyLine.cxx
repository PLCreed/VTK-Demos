...
int main(int argc, char *argv[])
{
    ...
    splineFilter->SetInputData(polyData.Get());
    splineFilter->SetNumberOfSubdivisions(polyData->GetNumberOfPoints() * 10);
    splineFilter->SetSpline(spline.Get());
    ...
    splineActor->SetMapper(splineMapper.Get());
    ...
    glyphOriginal->SetInputData(polyData.Get());
    ...
    originalActor->GetProperty()->SetColor(colors->GetColor3d("Banana").GetData());
    ...
    newActor->SetMapper(newMapper.Get());
    ...
    renderer->AddActor(newActor.Get());
    renderer->AddActor(splineActor.Get());
