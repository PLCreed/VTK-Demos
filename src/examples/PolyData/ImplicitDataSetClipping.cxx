...
int main(int, char *[])
{
    ...
    std::cout << "The sphere has " << sphereSource->GetOutput()->GetNumberOfPoints() << " points."
              << " and " << sphereSource->GetOutput()->GetNumberOfCells() << " cells. " << std::endl;
    ...
    clipper->SetClipFunction(implicitCube.Get());
    ...
    vtkIdTypeArray *clippedCellIds = dynamic_cast<vtkIdTypeArray *>(clipped->GetCellData()->GetArray("CellIds"));
    ...
    clippedActor->SetMapper(clippedMapper.Get());
    ...
    renderer->AddActor(clippedActor.Get());
