...
int main(int, char *[])
{
    ...
    ren1->AddActor(Actor1a.Get());
    ren1->AddActor(Actor1b.Get());
    ren1->AddActor(Actor1c.Get());

    ren2->AddActor(Actor2a.Get());
    ren2->AddActor(Actor2b.Get());
    ren2->AddActor(Actor2c.Get());

    ren3->AddActor(Actor3a.Get());
    ren3->AddActor(Actor3b.Get());
    ren3->AddActor(Actor3c.Get());
