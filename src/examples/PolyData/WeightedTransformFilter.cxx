...
int main(int, char *[])
{
    ...
    sphereData->GetPointData()->AddArray(tfarray.Get());
    ...
    stretchFilter->SetTransform(stretch.Get());
    ...
    weightedTrans->SetTransform(identity.Get(), 0);
    weightedTrans->SetTransform(rotated.Get(), 1);
    ...
    weightedTransActor->SetMapper(weightedTransMapper.Get());
    weightedTransActor->GetProperty()->SetDiffuseColor(colors->GetColor3d("Banana").GetData());
    ...
    renderer->AddActor(weightedTransActor.Get());
