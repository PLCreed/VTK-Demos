...
public:
    ...
    virtual void OnLeftButtonDown() override
    {
        ...
        std::cout << "There are currently: " << this->VisibleFilter->GetOutput()->GetNumberOfPoints() << " visible."
                  << std::endl;
        // Forward events
