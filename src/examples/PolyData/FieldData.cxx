...
int main(int, char *[])
{
    ...
    polydata->GetFieldData()->AddArray(location.Get());
    ...
    polydata->GetFieldData()->AddArray(intValue.Get());

    // Get the data back out
    auto retrievedArray = dynamic_cast<vtkIntArray *>(polydata->GetFieldData()->GetAbstractArray("MyIntValue"));
