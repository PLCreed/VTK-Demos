...
int main(int, char *[])
{
    ...
    std::cout << "There are " << points->GetNumberOfPoints() << " input points." << std::endl;
    ...
    for (unsigned int i = 0; i < 10; i++) {
        ...
        std::cout << "\tPoint: " << outsideSet[0] << ", " << outsideSet[1] << ", " << outsideSet[2] << " ";

        std::cout << "Inserted? " << ((inserted == 0) ? "No, " : "Yes, ");
        std::cout << "Id:: " << id << std::endl;
    }

    std::cout << "There are now " << points->GetNumberOfPoints() << " points." << std::endl;
