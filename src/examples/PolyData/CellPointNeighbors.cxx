...
int main(int, char *[])
{
    ...
    triangleFilter->GetOutput()->GetCellPoints(cellId, cellPointIds.Get());
    ...
    for (vtkIdType i = 0; i < cellPointIds->GetNumberOfIds(); i++) {
        ...
        triangleFilter->GetOutput()->GetCellNeighbors(cellId, idList.Get(), neighborCellIds.Get());
    ...
    mainCellActor->SetMapper(mainCellMapper.Get());
    ...
    neighborCellsActor->SetMapper(neighborCellsMapper.Get());
    ...
    renderer->AddActor(mainCellActor.Get());
    renderer->AddActor(neighborCellsActor.Get());
