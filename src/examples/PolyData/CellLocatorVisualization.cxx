...
int main(int, char *[])
{
    ...
    pointsActor->GetProperty()->SetColor(colors->GetColor3d("MistyRose").GetData());
    ...
    cellLocator->GenerateRepresentation(0, polydata.Get());
    ...
    locatorTreeActor->GetProperty()->SetColor(colors->GetColor3d("Gold").GetData());
    ...
    callback->CellLocator = cellLocator.Get();
