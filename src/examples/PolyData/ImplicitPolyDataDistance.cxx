...
int main(int, char *[])
{
    ...
    polyData->GetPointData()->SetScalars(signedDistances.Get());

    vtkNew<vtkVertexGlyphFilter> vertexGlyphFilter;
    vertexGlyphFilter->SetInputData(polyData.Get());
    ...
    signedDistanceActor->SetMapper(signedDistanceMapper.Get());

    vtkNew<vtkRenderer> renderer;
    renderer->AddViewProp(sphereActor.Get());
    renderer->AddViewProp(signedDistanceActor.Get());
