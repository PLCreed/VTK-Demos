...
int main(int argc, char *argv[])
{
    ...
    cutter->SetInputData(polyData.Get());
    ...
    model->SetMapper(modelMapper.Get());
    ...
    lines->SetMapper(linesMapper.Get());
    ...
    renderer->AddActor(model.Get());
    renderer->AddActor(lines.Get());
