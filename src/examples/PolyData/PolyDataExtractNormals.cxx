...
int main(int argc, char *argv[])
{
    ...
    TestPointNormals(polydata.Get());

    TestCellNormals(polydata.Get());
...
bool GetCellNormals(vtkPolyData *polydata)
{
    ...
    ////////////////////////////////////////////////////////////////
    // Double normals in an array
    vtkDoubleArray *normalDataDouble = dynamic_cast<vtkDoubleArray *>(polydata->GetCellData()->GetArray("Normals"));
    ...
    ////////////////////////////////////////////////////////////////
    // Double normals in an array
    vtkFloatArray *normalDataFloat = dynamic_cast<vtkFloatArray *>(polydata->GetCellData()->GetArray("Normals"));
    ...
    ////////////////////////////////////////////////////////////////
    // Point normals
    vtkDoubleArray *normalsDouble = dynamic_cast<vtkDoubleArray *>(polydata->GetCellData()->GetNormals());
    ...
    ////////////////////////////////////////////////////////////////
    // Point normals
    vtkFloatArray *normalsFloat = dynamic_cast<vtkFloatArray *>(polydata->GetCellData()->GetNormals());
