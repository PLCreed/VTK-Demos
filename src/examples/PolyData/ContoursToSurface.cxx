...
int main(int, char *[])
{
    ...
    for (int i = 0; i <= numDivisions; ++i) {
        ...
        CreateCircle(z, radius, resolution, circle.Get());
        appendFilter->AddInputData(circle.Get());
    }
    ...
    double spacing[3] = {(bounds[1] - bounds[0]) / 40, (bounds[3] - bounds[2]) / 40, deltaz};
    ...
    contoursToSurface->SetInputData(poly.Get());
    ...
    contoursActor->SetMapper(contoursMapper.Get());
    ...
    surfaceActor->GetProperty()->SetColor(colors->GetColor3d("MistyRose").GetData());
    ...
    renderer1->AddViewProp(surfaceActor.Get());
    renderer2->AddViewProp(contoursActor.Get());
    renderWindow->Render();
