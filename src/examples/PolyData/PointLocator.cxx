...
int main(int, char *[])
{
    ...
    std::cout << "There are " << pointLocator->GetNumberOfPointsPerBucket() << " points per bucket." << endl;

    vtkNew<vtkPolyData> polydata;
    pointLocator->GenerateRepresentation(pointLocator->GetLevel(), polydata.Get());
    ...
    style->pointLocator = pointLocator.Get();
    style->renderWindow = renderWindow.Get();
    style->polydata = polydata.Get();
