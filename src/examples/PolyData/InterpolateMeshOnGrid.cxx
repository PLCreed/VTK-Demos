...
void CameraModifiedCallback(vtkObject *caller, long unsigned int vtkNotUsed(eventId), void *vtkNotUsed(clientData),
...
int main(int, char *[])
{
    ...
    randomPolyData->SetPoints(randomPoints.Get());
    randomPolyData->GetPointData()->SetScalars(zvalues.Get());
    ...
    randomDelaunay->SetInputData(randomPolyData.Get());
    ...
    randomActor->SetMapper(randomMapper.Get());
    ...
    renderer->AddActor(randomActor.Get());
