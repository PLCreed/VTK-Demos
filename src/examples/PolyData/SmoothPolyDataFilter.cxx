...
int main(int, char *[])
{
    ...
    inputPolyData->SetPoints(points.Get());

    // Triangulate the grid points
    vtkNew<vtkDelaunay2D> delaunay;
    delaunay->SetInputData(inputPolyData.Get());
    delaunay->Update();
    ...
    smoothedActor->SetMapper(smoothedMapper.Get());
    smoothedActor->GetProperty()->SetColor(colors->GetColor3d("MistyRose").GetData());
    ...
    rightRenderer->AddActor(smoothedActor.Get());
