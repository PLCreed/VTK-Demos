...
int main(int, char *[])
{
    ...
    std::cout << "There are " << points->GetNumberOfPoints() << " points before thresholding." << std::endl;
    ...
    polydata->GetPointData()->AddArray(index.Get());
    ...
    vtkPolyData *thresholdedPolydata = threshold->GetOutput();
    std::cout << "There are " << thresholdedPolydata->GetNumberOfPoints() << " points after thresholding." << std::endl;
