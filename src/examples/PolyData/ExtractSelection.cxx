...
int main(int, char *[])
{
    ...
    std::cout << selected->GetNumberOfCells() << " cells in the selection." << std::endl;
    ...
    std::cout << "There are " << notSelected->GetNumberOfPoints() << " points and ";
    std::cout << notSelected->GetNumberOfCells() << " cells NOT in the selection." << std::endl;

    vtkNew<vtkDataSetMapper> inputMapper;
    inputMapper->SetInputConnection(pointSource->GetOutputPort());
    vtkNew<vtkActor> inputActor;
    inputActor->SetMapper(inputMapper.Get());
    inputActor->GetProperty()->SetColor(colors->GetColor3d("MidnightBlue").GetData());
    ...
    selectedActor->GetProperty()->SetColor(colors->GetColor3d("MidnightBlue").GetData());
    ...
    notSelectedActor->GetProperty()->SetColor(colors->GetColor3d("MidnightBlue").GetData());
