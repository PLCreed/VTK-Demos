...
int main(int, char *[])
{
    ...
    triangles->InsertNextCell(triangle0.Get());
    triangles->InsertNextCell(triangle1.Get());
    triangles->InsertNextCell(triangle2.Get());
    ...
    polydata->GetCellData()->AddArray(index.Get());

    std::cout << "There are " << polydata->GetNumberOfCells() << " cells before thresholding." << std::endl;

    vtkNew<vtkThreshold> threshold;
    threshold->SetInputData(polydata.Get());
