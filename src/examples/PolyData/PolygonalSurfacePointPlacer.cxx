...
int main(int, char *[])
{
    ...
    contourWidget->SetInteractor(interactor.Get());

    vtkNew<MyCallback> callback;
    callback->SetSphereSource(sphereSource.Get());
    contourWidget->AddObserver(vtkCommand::InteractionEvent, callback.Get());
    ...
    rep->SetPointPlacer(pointPlacer.Get());
