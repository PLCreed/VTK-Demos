...
int main(int, char *[])
{
    ...
    double tol = 1.0e-8;
    tree->IntersectWithLine(lineP0, lineP1, tol, intersectPoints.Get(), intersectCells.Get());
    ...
    for (int i = 0; i < intersectPoints->GetNumberOfPoints(); i++) {
        ...
        std::cout << "\tPoint Intersection " << i << ": " << intersection[0] << ", " << intersection[1] << ", "
    ...
    lineActor->SetMapper(lineMapper.Get());
    ...
    renderer->AddActor(lineActor.Get());
    renderer->AddActor(sphereActor.Get());
    renderer->AddActor(cellActor.Get());
