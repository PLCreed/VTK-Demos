...
public:
    ...
    void Initialize()
    {
        ...
        for (unsigned int i = 0; i < 4; i++) {
            ...
            this->renderers[i]->AddActor(actor.Get());

            this->renderers[i]->AddActor(meshActor.Get());
        }
        this->Level = 1;
    ...
    void ReDraw()
    {
        ...
        for (unsigned i = 0; i < 4; i++) {
            ...
            this->mappers[i]->SetInputData(polydata.Get());
        }
...
int main(int argc, char *argv[])
{
    ...
    for (unsigned int i = 0; i < 4; i++) {
        ...
        style->renderers.push_back(renderer.Get());
