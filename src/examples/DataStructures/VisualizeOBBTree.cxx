...
int main(int argc, char *argv[])
{
    ...
    obbTree->GenerateRepresentation(0, polydata.Get());

    vtkNew<vtkPolyDataMapper> obbtreeMapper;
    obbtreeMapper->SetInputData(polydata.Get());

    vtkNew<vtkActor> obbtreeActor;
    obbtreeActor->SetMapper(obbtreeMapper.Get());
    ...
    renderer->AddActor(obbtreeActor.Get());
