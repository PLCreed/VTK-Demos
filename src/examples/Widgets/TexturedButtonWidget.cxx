...
namespace
{
void CreateImage(vtkImageData *image, std::string const &color1, std::string const &color2);
}
...
int main(int, char *[])
{
    ...
    CreateImage(image1.Get(), "Banana", "Tomato");
    CreateImage(image2.Get(), "Tomato", "Banana");
    ...
    buttonRepresentation->SetButtonTexture(0, image1.Get());
    buttonRepresentation->SetButtonTexture(1, image2.Get());
    ...
    double bds[6];
    double sz = 50.0;
    bds[0] = upperRight->GetComputedDisplayValue(renderer.Get())[0] - sz;
    bds[1] = bds[0] + sz;
    bds[2] = upperRight->GetComputedDisplayValue(renderer.Get())[1] - sz;
    bds[3] = bds[2] + sz;
    bds[4] = bds[5] = 0.0;
