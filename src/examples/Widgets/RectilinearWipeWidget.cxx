...
public:
    ...
    void SetWipe(vtkImageRectilinearWipe *wipe) { this->Wipe = wipe; }

protected:
    WipeInteractorStyle() { this->Wipe = NULL; }
...
{
    if (argc < 3) {
        std::cerr << "Usage: " << argv[0] << " Input1Filename Input2Filename e.g. Gourds2.jpg Ox.jpg" << std::endl;
        return EXIT_FAILURE;
    }
