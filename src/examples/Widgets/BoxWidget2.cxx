...
public:
    ...
    virtual void Execute(vtkObject *caller, unsigned long, void *)
    {
        ...
        dynamic_cast<vtkBoxRepresentation *>(boxWidget->GetRepresentation())->GetTransform(t.Get());
        this->m_actor->SetUserTransform(t.Get());
    }
...
int main(int vtkNotUsed(argc), char *vtkNotUsed(argv)[])
{
    ...
    boxWidget->SetInteractor(renderWindowInteractor.Get());
    ...
    boxCallback->SetActor(actor.Get());
    boxWidget->AddObserver(vtkCommand::InteractionEvent, boxCallback.Get());
