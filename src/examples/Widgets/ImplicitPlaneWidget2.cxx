...
int main(int argc, char *argv[])
{
    ...
    actor->SetBackfaceProperty(backFaces.Get());
    ...
    planeWidget->SetRepresentation(rep.Get());
    planeWidget->AddObserver(vtkCommand::InteractionEvent, myCallback.Get());
