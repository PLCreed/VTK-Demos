...
public:
    ...
    virtual void Execute(vtkObject *caller, unsigned long, void *)
    {
        ...
        static_cast<vtkLineRepresentation *>(lineWidget->GetRepresentation())->GetPolyData(polydata.Get());
...
int main(int, char *[])
{
    ...
    lineWidget->SetInteractor(renderWindowInteractor.Get());
    ...
    // lineWidget->SetRepresentation(lineRepresentation.Get());

    vtkNew<vtkLineCallback> lineCallback;

    lineWidget->AddObserver(vtkCommand::InteractionEvent, lineCallback.Get());
