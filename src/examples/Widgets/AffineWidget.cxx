...
public:
    ...
    vtkAffineCallback() : Actor(0), AffineRep(0) { this->Transform = vtkTransform::New(); }
...
int main(int, char *[])
{
    ...
    dynamic_cast<vtkInteractorStyleSwitch *>(renderWindowInteractor->GetInteractorStyle())
    ...
    affineWidget->SetInteractor(renderWindowInteractor.Get());
    ...
    affineCallback->Actor = actor.Get();
    affineCallback->AffineRep = dynamic_cast<vtkAffineRepresentation2D *>(affineWidget->GetRepresentation());

    affineWidget->AddObserver(vtkCommand::InteractionEvent, affineCallback.Get());
    affineWidget->AddObserver(vtkCommand::EndInteractionEvent, affineCallback.Get());
