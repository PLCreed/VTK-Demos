...
int main(int, char *[])
{
    ...
    sliderRep->GetSelectedProperty()->SetColor(colors->GetColor3d("Lime").GetData());

    // Change the color of the bar
    sliderRep->GetTubeProperty()->SetColor(colors->GetColor3d("Yellow").GetData());
    ...
    callback->SphereSource = sphereSource.Get();
