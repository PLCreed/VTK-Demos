...
int main(int argc, char *argv[])
{
    ...
    if (argc != 2) {
        std::cerr << "Usage: " << argv[0] << " Filename(.vtk) e.g.uGridEx.vtk" << std::endl;
        return EXIT_FAILURE;
    }
    ...
    scalarBarWidget->SetInteractor(interactor.Get());
    scalarBarWidget->SetScalarBarActor(scalarBar.Get());
    scalarBarWidget->On();
