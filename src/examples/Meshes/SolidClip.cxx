...
int main(int, char *[])
{
    ...
    clipper->SetClipFunction(clipPlane.Get());
    ...
    superquadricActor->SetMapper(superquadricMapper.Get());
    ...
    superquadricActor->SetBackfaceProperty(backFaces.Get());
    ...
    clippedAwayActor->SetMapper(clippedAwayMapper.Get());
    clippedAwayActor->GetProperty()->SetDiffuseColor(colors->GetColor3d("Silver").GetData());
    ...
    renderer->AddActor(superquadricActor.Get());
    renderer->AddActor(clippedAwayActor.Get());
