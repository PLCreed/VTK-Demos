...
int main(int argc, char *argv[])
{
    ...
    outMapper->SetInputData(polyData.Get());
    outMapper->ScalarVisibilityOff();

    vtkNew<vtkActor> outActor;
    outActor->SetMapper(outMapper.Get());
    ...
    frustumSource->SetPlanes(planes.Get());
    ...
    frustumActor->SetMapper(frustumMapper.Get());
    ...
    clip->SetInputData(polyData.Get());
    clip->SetClipFunction(planes.Get());
    clip->InsideOutOn();
    ...
    renderer->AddActor(frustumActor.Get());
    renderer->AddActor(outActor.Get());
