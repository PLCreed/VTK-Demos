...
int main(int, char *[])
{
    ...
    triangleActor->SetMapper(triangleMapper.Get());
    triangleActor->GetProperty()->SetRepresentationToWireframe();
    triangleActor->GetProperty()->SetColor(colors->GetColor3d("MistyRose").GetData());
    ...
    rightRenderer->AddActor(triangleActor.Get());
