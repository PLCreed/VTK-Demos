...
int main(int argc, char *argv[])
{
    ...
    fillHolesFilter->SetInputData(input.Get());
  ...
  normals->GetOutput()->GetPointData()->
    ...
    originalMapper->SetInputData(input.Get());
    ...
    originalActor->GetProperty()->SetDiffuseColor(colors->GetColor3d("NavajoWhite").GetData());
    ...
    filledActor->GetProperty()->SetDiffuseColor(colors->GetColor3d("NavajoWhite").GetData());
    filledActor->SetBackfaceProperty(backfaceProp.Get());
    ...
    rightRenderer->AddActor(filledActor.Get());
