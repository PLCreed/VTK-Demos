...
int main(int argc, char *argv[])
{
    ...
    decimate->SetInputData(inputPolyData.Get());
    ...
    inputMapper->SetInputData(inputPolyData.Get());
    ...
    inputActor->GetProperty()->SetColor(colors->GetColor3d("NavajoWhite").GetData());
    inputActor->SetBackfaceProperty(backFace.Get());

    vtkNew<vtkPolyDataMapper> decimatedMapper;
    decimatedMapper->SetInputData(decimated.Get());

    vtkNew<vtkActor> decimatedActor;
    decimatedActor->SetMapper(decimatedMapper.Get());
    decimatedActor->GetProperty()->SetColor(colors->GetColor3d("NavajoWhite").GetData());
    decimatedActor->GetProperty()->SetInterpolationToFlat();
    decimatedActor->SetBackfaceProperty(backFace.Get());
    ...
    rightRenderer->AddActor(decimatedActor.Get());
