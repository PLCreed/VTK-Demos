...
int main(int argc, char *argv[])
{
    ...
    clipper->SetInputData(polyData.Get());
    ...
    clipMapper->SetInputData(polyData.Get());
    ...
    boundaryEdges->SetInputData(polyData.Get());
    ...
    boundaryMapper->SetInputData(boundaryPoly.Get());

    vtkNew<vtkActor> boundaryActor;
    boundaryActor->SetMapper(boundaryMapper.Get());
    ...
    //
    renderer->AddActor(clipActor.Get());
    renderer->AddActor(boundaryActor.Get());
