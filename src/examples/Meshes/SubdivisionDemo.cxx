...
int main(int argc, char *argv[])
{
    ...
    if (argc > 1)                              // If a file name is specified, open and use the file.
    {
        ...
        triangles->SetInputData(polyData.Get());
        triangles->Update();
    ...
    for (unsigned i = 0; i < numberOfViewports; i++) {
        ...
        case 0 :
            ...
            legend->SetEntry(i, subdivisionFilter->GetOutput(), "Linear", originalColor.GetData());
            break;
        case 1 :
            ...
            legend->SetEntry(i, subdivisionFilter->GetOutput(), "Loop", loopColor.GetData());
            break;
        case 2 :
            ...
            legend->SetEntry(i, subdivisionFilter->GetOutput(), "Butterfly", butterflyColor.GetData());
            break;
        default :
            break;
        }
        subdivisionFilter->SetInputData(originalMesh.Get());
